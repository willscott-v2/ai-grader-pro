...
export async function discoverEntities(pageData) {
  ...
  const prompt = `You are an expert in semantic SEO and entity analysis.
...
6. **Location** - City, state, and region where this business/organization is located (look for addresses, "located in", etc.)
